...
public class FractalExplorer 
{
	...
	public void createAndShowGUI() {
		// Создание формы
		this.frame = new JFrame("Fraсtal drawing");
	...
	// Для отрисовки фрактала, в цикле идёт проход по всем пикселям и определяется, входит ли он в площадь фрактала.
	// Степень вхождения определяется цветом пикселя.
